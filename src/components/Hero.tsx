  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-40 right-32 w-2 h-2 bg-indigo-400 rounded-full opacity-60 animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-32 left-1/3 w-3 h-3 bg-blue-300 rounded-full opacity-60 animate-pulse"
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/4 text-blue-200/40 font-mono text-sm animate-float">
          {"<div>"}
        </div>
        <div
          className="absolute top-1/3 right-1/4 text-indigo-200/40 font-mono text-sm animate-float"
          style={{ animationDelay: "1s" }}
        >
          {"</>"}
        </div>
        <div
          className="absolute bottom-1/3 left-1/6 text-blue-300/40 font-mono text-sm animate-float"
          style={{ animationDelay: "2s" }}
        >
          {"{ }"}
        </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto py-10 md:py-6 px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8">
          ...
          <div className="flex gap-4 pt-4">
            <a
              ...
              target="_blank"
              className="p-3 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-full text-slate-600 hover:text-blue-600 hover:border-blue-300 transition-all duration-300 shadow-sm hover:shadow-md"
            >
            ...
            <a
              href="mailto:oluwaseyiea@gmail.com"
              className="p-3 bg-white/80 backdrop-blur-sm border border-slate-200 rounded-full text-slate-600 hover:text-blue-600 hover:border-blue-300 transition-all duration-300 shadow-sm hover:shadow-md"
            >
        ...
        <div className="relative flex items-center justify-center lg:justify-self-end">
          <div className="relative w-80 h-80 sm:w-96 sm:h-96 lg:w-[450px] lg:h-[450px] xl:w-[500px] xl:h-[500px] mx-auto">
            {/* Profile Picture */}
            <div className="absolute inset-0 rounded-3xl overflow-hidden shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500 group">
              <img
                src={heroPicture}

              ...
              {activeTab === "story" && (
                <div className="space-y-6 animate-fade-in">
                  ...
                  <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-slate-200 shadow-sm">
                    ...
                    My passion for building extends beyond client projects. I'm actively building <a href="https://x.com/Thrive_Links" target="_blank" className="font-semibold text-blue-600">Thrive Link</a>, a platform that connects 
                    tech enthusiasts for collaboration and learning. This project has been a valuable opportunity to apply my skills in 
                    real-world problem-solving, showcasing my technical leadership and my commitment to community and continuous learning.
                    </p>
                  </div>
                </div>
              )}

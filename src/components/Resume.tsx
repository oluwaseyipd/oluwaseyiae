      ...
      <div className="relative z-10 max-w-6xl mx-auto sm:px-6 md:px-12 lg:px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-2xl mx-auto">
            A comprehensive overview of my skills, experience, and journey in
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-8">
                My resume showcases my technical expertise, professional
                experience, and the projects that have shaped my development
                journey. It's designed to give you a complete picture of what I
                bring to the table.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600">
                      2+ years of frontend development experience with hands-on
          ...
          <div className="relative">
                ...
                <div className="p-6 space-y-6 text-sm">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-600">
                      Software Development • SQI College of ICT
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div
              className="absolute -bottom-4 -left-4 w-6 h-6 bg-gradient-to-r from-indigo-400 to-purple-400 rounded-full shadow-lg animate-pulse"
              style={{ animationDelay: "1s" }}
            ></div>
            <div
              className="absolute top-1/2 -left-2 w-4 h-4 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full shadow-lg animate-pulse"
